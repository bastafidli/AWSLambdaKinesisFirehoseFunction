...
Execute unit tests
```
    cd "AWSLambdaKinesisFirehoseFunction/test/AWSLambdaKinesisFirehoseFunction.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSLambdaKinesisFirehoseFunction/src/AWSLambdaKinesisFirehoseFunction"
